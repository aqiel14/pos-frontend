...
export default (props) => {
  ...
  const [listprostat, setListprostat] = useState([]);
  ...
  useEffect(() => {
    ...
    dispatch(StatActions.getCurrentListproStat());
        ...
        <div className='container-fluid'>
          <div className='row mb-2'>
            <div className='col-sm-6'>
              <h1 className='m-0 text-dark'>Production Dashboard</h1>
            </div>
            {/* /.col */}
            <div className='col-sm-6'>
              ...
              <div className='card'>
                <div className='card-header'>
                  <h3 className='card-title'>
                    ...
                    Weekly Production Report : {moment().format('MMMM')}
                  </h3>
